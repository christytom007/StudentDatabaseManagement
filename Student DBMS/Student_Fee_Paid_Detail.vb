...
Imports System.IO
Public Class Student_Fee_Paid_Detail
    ...
    Public Shared Admission As String
    ...
    Private Sub MetroButton6_Click(sender As Object, e As EventArgs) Handles MetroButton6.Click
        ...
        If MetroLabel36.Text = Nothing Then
            ...
            Exit Sub
        End If
        Student_Fee_Paid_Detail_View.Show()
        Hide()
    End Sub

    Private Sub Student_Fee_Paid_Detail_Shown(sender As Object, e As EventArgs) Handles Me.Shown
        'Form Loads
        MetroLabel36.Text = ""
        MetroLabel1.Text = ""
        MetroLabel6.Text = ""
