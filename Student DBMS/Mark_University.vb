...
Public Class Mark_University
    ...
    Dim Sem As Integer
    Private Sub Mark_University_Closing(sender As Object, e As CancelEventArgs) Handles Me.Closing
        'Closing
        Mark_Main_Menu.Show()
    End Sub

    Private Sub Mark_University_Shown(sender As Object, e As EventArgs) Handles Me.Shown
        'Form Loads
        MetroLabel4.Text = ""
    ...
    Private Sub MetroButton4_Click(sender As Object, e As EventArgs) Handles MetroButton4.Click
        ...
        Try
            ...
            If Not con.State = ConnectionState.Open Then
                ...
                con.Open()
            End If
            sql1 = "UPDATE Y1 SET [Uni_Sub1]=" & Convert.ToInt32(MetroTextBox1.Text) & ",[Uni_Sub2]=" & Convert.ToInt32(MetroTextBox2.Text) & ",[Uni_Sub3]=" & Convert.ToInt32(MetroTextBox3.Text) & ",[Uni_Sub4]=" & Convert.ToInt32(MetroTextBox4.Text) & ",[Uni_Sub5]=" & Convert.ToInt32(MetroTextBox5.Text) & ",[Uni_Sub6]=" & Convert.ToInt32(MetroTextBox6.Text) & ",[Uni_Sub7]=" & Convert.ToInt32(MetroTextBox7.Text) & ",[Uni_Sub8]=" & Convert.ToInt32(MetroTextBox8.Text) & ",[Uni_Sub9]=" & Convert.ToInt32(MetroTextBox9.Text) & ",[Uni_Lab1]=" & Convert.ToInt32(MetroTextBox10.Text) & ",[Uni_Lab2]=" & Convert.ToInt32(MetroTextBox11.Text) & ",[Uni_Lab3]=" & Convert.ToInt32(MetroTextBox12.Text) & " " &
    ...
    Private Sub MetroButton5_Click(sender As Object, e As EventArgs) Handles MetroButton5.Click
        ...
        Try
            ...
            If Not con.State = ConnectionState.Open Then
                ...
                con.Open()
            End If
            sql1 = "UPDATE S3 SET [Uni_Sub1]=" & Convert.ToInt32(MetroTextBox31.Text) & ",[Uni_Sub2]=" & Convert.ToInt32(MetroTextBox30.Text) & ",[Uni_Sub3]=" & Convert.ToInt32(MetroTextBox29.Text) & ",[Uni_Sub4]=" & Convert.ToInt32(MetroTextBox28.Text) & ",[Uni_Sub5]=" & Convert.ToInt32(MetroTextBox27.Text) & ",[Uni_Sub6]=" & Convert.ToInt32(MetroTextBox25.Text) & ",[Uni_Lab1]=" & Convert.ToInt32(MetroTextBox32.Text) & ",[Uni_Lab2]=" & Convert.ToInt32(MetroTextBox33.Text) & " " &
                "WHERE Student_ID='" & Admission_NO & "'"
            cmd = New OleDbCommand(sql1)
            cmd.Connection = con
            RecordCount = cmd.ExecuteNonQuery()
    ...
    Private Sub MetroButton6_Click(sender As Object, e As EventArgs) Handles MetroButton6.Click
        ...
        Try
            ...
            If Not con.State = ConnectionState.Open Then
                ...
                con.Open()
            End If
            sql1 = "UPDATE S4 SET [Uni_Sub1]=" & Convert.ToInt32(MetroTextBox57.Text) & ",[Uni_Sub2]=" & Convert.ToInt32(MetroTextBox53.Text) & ",[Uni_Sub3]=" & Convert.ToInt32(MetroTextBox49.Text) & ",[Uni_Sub4]=" & Convert.ToInt32(MetroTextBox47.Text) & ",[Uni_Sub5]=" & Convert.ToInt32(MetroTextBox45.Text) & ",[Uni_Sub6]=" & Convert.ToInt32(MetroTextBox43.Text) & ",[Uni_Lab1]=" & Convert.ToInt32(MetroTextBox56.Text) & ",[Uni_Lab2]=" & Convert.ToInt32(MetroTextBox51.Text) & " " &
                "WHERE Student_ID='" & Admission_NO & "'"
            cmd = New OleDbCommand(sql1)
            cmd.Connection = con
            RecordCount = cmd.ExecuteNonQuery()
    ...
    Private Sub MetroButton7_Click(sender As Object, e As EventArgs) Handles MetroButton7.Click
        ...
        Try
            ...
            If Not con.State = ConnectionState.Open Then
                ...
                con.Open()
            End If
            sql1 = "UPDATE S5 SET [Uni_Sub1]=" & Convert.ToInt32(MetroTextBox73.Text) & ",[Uni_Sub2]=" & Convert.ToInt32(MetroTextBox69.Text) & ",[Uni_Sub3]=" & Convert.ToInt32(MetroTextBox65.Text) & ",[Uni_Sub4]=" & Convert.ToInt32(MetroTextBox63.Text) & ",[Uni_Sub5]=" & Convert.ToInt32(MetroTextBox61.Text) & ",[Uni_Sub6]=" & Convert.ToInt32(MetroTextBox59.Text) & ",[Uni_Lab1]=" & Convert.ToInt32(MetroTextBox72.Text) & ",[Uni_Lab2]=" & Convert.ToInt32(MetroTextBox67.Text) & " " &
                   "WHERE Student_ID='" & Admission_NO & "'"
            cmd = New OleDbCommand(sql1)
            cmd.Connection = con
            RecordCount = cmd.ExecuteNonQuery()
    ...
    Private Sub MetroButton8_Click(sender As Object, e As EventArgs) Handles MetroButton8.Click
        ...
        Try
            ...
            If Not con.State = ConnectionState.Open Then
                ...
                con.Open()
            End If
            sql1 = "UPDATE S6 SET [Uni_Sub1]=" & Convert.ToInt32(MetroTextBox89.Text) & ",[Uni_Sub2]=" & Convert.ToInt32(MetroTextBox85.Text) & ",[Uni_Sub3]=" & Convert.ToInt32(MetroTextBox81.Text) & ",[Uni_Sub4]=" & Convert.ToInt32(MetroTextBox79.Text) & ",[Uni_Sub5]=" & Convert.ToInt32(MetroTextBox77.Text) & ",[Uni_Sub6]=" & Convert.ToInt32(MetroTextBox75.Text) & ",[Uni_Lab1]=" & Convert.ToInt32(MetroTextBox88.Text) & ",[Uni_Lab2]=" & Convert.ToInt32(MetroTextBox83.Text) & " " &
                   "WHERE Student_ID='" & Admission_NO & "'"
            cmd = New OleDbCommand(sql1)
            cmd.Connection = con
            RecordCount = cmd.ExecuteNonQuery()
    ...
    Private Sub MetroButton9_Click(sender As Object, e As EventArgs) Handles MetroButton9.Click
        ...
        Try
            ...
            If Not con.State = ConnectionState.Open Then
                ...
                con.Open()
            End If
            sql1 = "UPDATE S7 SET [Uni_Sub1]=" & Convert.ToInt32(MetroTextBox105.Text) & ",[Uni_Sub2]=" & Convert.ToInt32(MetroTextBox101.Text) & ",[Uni_Sub3]=" & Convert.ToInt32(MetroTextBox97.Text) & ",[Uni_Sub4]=" & Convert.ToInt32(MetroTextBox95.Text) & ",[Uni_Sub5]=" & Convert.ToInt32(MetroTextBox93.Text) & ",[Uni_Sub6]=" & Convert.ToInt32(MetroTextBox91.Text) & ",[Uni_Lab1]=" & Convert.ToInt32(MetroTextBox104.Text) & ",[Uni_Lab2]=" & Convert.ToInt32(MetroTextBox99.Text) & " " &
                "WHERE Student_ID='" & Admission_NO & "'"
            cmd = New OleDbCommand(sql1)
            cmd.Connection = con
            RecordCount = cmd.ExecuteNonQuery()
    ...
    Private Sub MetroButton10_Click(sender As Object, e As EventArgs) Handles MetroButton10.Click
        ...
        Try
            ...
            If Not con.State = ConnectionState.Open Then
                ...
                con.Open()
            End If
            sql1 = "UPDATE S8 SET [Uni_Sub1]=" & Convert.ToInt32(MetroTextBox121.Text) & ",[Uni_Sub2]=" & Convert.ToInt32(MetroTextBox117.Text) & ",[Uni_Sub3]=" & Convert.ToInt32(MetroTextBox113.Text) & ",[Uni_Sub4]=" & Convert.ToInt32(MetroTextBox111.Text) & ",[Uni_Lab1]=" & Convert.ToInt32(MetroTextBox109.Text) & ",[Uni_Lab2]=" & Convert.ToInt32(MetroTextBox107.Text) & " " &
                "WHERE Student_ID='" & Admission_NO & "'"
            cmd = New OleDbCommand(sql1)
            cmd.Connection = con
            RecordCount = cmd.ExecuteNonQuery()
    ...
    Private Sub MetroGrid1_CellDoubleClick(sender As Object, e As DataGridViewCellEventArgs) Handles MetroGrid1.CellDoubleClick
        ...
        Try
            ...
            If Not con.State = ConnectionState.Open Then
                ...
                con.Open()
            End If
            sql1 = "SELECT Uni_Sub1,Uni_Sub2,Uni_Sub3,Uni_Sub4,Uni_Sub5,Uni_Sub6,Uni_Sub7,Uni_Sub8,Uni_Sub9,Uni_Lab1,Uni_Lab2,Uni_Lab3 From Y1 WHERE Student_ID='" & Admission_NO & "'"
            cmd = New OleDbCommand(sql1)
            cmd.Connection = con
        ...
        Try
            ...
            If Not con.State = ConnectionState.Open Then
                ...
                con.Open()
            End If
            sql1 = "SELECT Uni_Sub1,Uni_Sub2,Uni_Sub3,Uni_Sub4,Uni_Sub5,Uni_Sub6,Uni_Lab1,Uni_Lab2 From S3 WHERE Student_ID='" & Admission_NO & "'"
            cmd = New OleDbCommand(sql1)
            cmd.Connection = con
            rdr1 = cmd.ExecuteReader()
            If rdr1.Read Then
        ...
        Try
            ...
            If Not con.State = ConnectionState.Open Then
                ...
                con.Open()
            End If
            sql1 = "SELECT Uni_Sub1,Uni_Sub2,Uni_Sub3,Uni_Sub4,Uni_Sub5,Uni_Sub6,Uni_Lab1,Uni_Lab2 From S4 WHERE Student_ID='" & Admission_NO & "'"
            cmd = New OleDbCommand(sql1)
            cmd.Connection = con
            rdr1 = cmd.ExecuteReader()
            If rdr1.Read Then
        ...
        Try
            ...
            If Not con.State = ConnectionState.Open Then
                ...
                con.Open()
            End If
            sql1 = "SELECT Uni_Sub1,Uni_Sub2,Uni_Sub3,Uni_Sub4,Uni_Sub5,Uni_Sub6,Uni_Lab1,Uni_Lab2 From S5 WHERE Student_ID='" & Admission_NO & "'"
            cmd = New OleDbCommand(sql1)
            cmd.Connection = con
            rdr1 = cmd.ExecuteReader()
            If rdr1.Read() Then
        ...
        Try
            ...
            If Not con.State = ConnectionState.Open Then
                ...
                con.Open()
            End If
            sql1 = "SELECT Uni_Sub1,Uni_Sub2,Uni_Sub3,Uni_Sub4,Uni_Sub5,Uni_Sub6,Uni_Lab1,Uni_Lab2 From S6 WHERE Student_ID='" & Admission_NO & "'"
            cmd = New OleDbCommand(sql1)
            cmd.Connection = con
            rdr1 = cmd.ExecuteReader()
            If rdr1.Read Then
        ...
        Try
            ...
            If Not con.State = ConnectionState.Open Then
                ...
                con.Open()
            End If
            sql1 = "SELECT Uni_Sub1,Uni_Sub2,Uni_Sub3,Uni_Sub4,Uni_Sub5,Uni_Sub6,Uni_Lab1,Uni_Lab2 From S7 WHERE Student_ID='" & Admission_NO & "'"
            cmd = New OleDbCommand(sql1)
            cmd.Connection = con
            rdr1 = cmd.ExecuteReader()
            If rdr1.Read Then
        ...
        Try
            ...
            If Not con.State = ConnectionState.Open Then
                ...
                con.Open()
            End If
            sql1 = "SELECT Uni_Sub1,Uni_Sub2,Uni_Sub3,Uni_Sub4,Uni_Lab1,Uni_Lab2 From S8 WHERE Student_ID='" & Admission_NO & "'"
            cmd = New OleDbCommand(sql1)
            cmd.Connection = con
            rdr1 = cmd.ExecuteReader()
            If rdr1.Read Then
