...
Imports System.IO
Public Class Student_Fee_Paid_Detail_View
    ...
    Private Sub Student_Fee_Paid_Detail_View_Shown(sender As Object, e As EventArgs) Handles Me.Shown
        'Form Loads
        Admission_NO = Student_Fee_Paid_Detail.Admission
        RecordCount = 0
        Try
    ...
    Private Sub Student_Fee_Paid_Detail_View_Closing(sender As Object, e As CancelEventArgs) Handles Me.Closing
        'Closing
