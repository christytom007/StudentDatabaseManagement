...
Public Class Student_New
    ...
    Private Sub Student_New_Shown(sender As Object, e As EventArgs) Handles Me.Shown
        ...
        Try
            ...
            Dim sql As String = "SELECT Max(CDBL(Admission_No)) from Student"
            'Select Query
            ...
            rdr.Read()
            MetroLabel3.Text = (Convert.ToInt32(rdr.GetValue(0))) + 1
    ...
    Private Sub MetroButton3_Click(sender As Object, e As EventArgs) Handles MetroButton3.Click
        ...
        If MetroComboBox1.Text = Nothing Then
            MetroMessageBox.Show(Me, "Please Select Student Blood..", "Error", MessageBoxButtons.OK, MessageBoxIcon.Warning)
            MetroTextBox1.Focus()
            Exit Sub
        End If
    ...
    Private Sub MetroButton4_Click(sender As Object, e As EventArgs) Handles MetroButton4.Click
        ...
        Try
            ...
            sql1 = "INSERT INTO [Student] ([Admission_No],[First_Name],[Last_Name],[Gender],[Date_of_Birth],[Blood_Group],[Address],[City],[State],[Country],[Postal_Code],[EMail_ID],[Home_Phone],[Mobile_Phone],[Seat_Type],[Course],[Scheme],[Last_School_Name],[School_Address],[Plus_Two_Percentage],[Student_Photo],[Reg_No]) " &
                "VALUES('" & MetroLabel3.Text & "','" & MetroTextBox1.Text & "','" & MetroTextBox2.Text & "','" & Gen & "','" & MetroDateTime1.Value.Date & "','" & MetroComboBox1.Text & "','" & MetroTextBox3.Text & "','" & MetroTextBox4.Text & "','" & MetroTextBox5.Text & "','" & MetroTextBox6.Text & "','" & MetroTextBox7.Text & "','" & MetroTextBox8.Text & "','" & MetroTextBox9.Text & "','" & MetroTextBox10.Text & "','" & MetroComboBox2.Text & "','" & MetroComboBox3.Text & "','" & MetroComboBox4.Text & "','" & MetroTextBox11.Text & "','" & MetroTextBox12.Text & "','" & MetroTextBox13.Text & "',PictureL,'0')"
            ...
            sql2 = "INSERT INTO [Guardians] ([Student_ID],[Father_Name],[First_Name],[Last_Name],[Gender],[Relation],[Company],[Job_Title],[Business_Phone],[Home_Phone],[Mobile_Phone],[Address]) " &
                "Values('" & MetroLabel3.Text & "','" & MetroTextBox16.Text & "','" & MetroTextBox15.Text & "','" & MetroTextBox14.Text & "','" & GuGen & "','" & MetroTextBox17.Text & "','" & MetroTextBox18.Text & "','" & MetroTextBox19.Text & "','" & MetroTextBox20.Text & "','" & MetroTextBox21.Text & "','" & MetroTextBox22.Text & "','" & MetroTextBox23.Text & "')"

            sqlFee = "INSERT INTO [Fee_Paid] (Student_ID) VALUES('" & MetroLabel3.Text & "')"


            sqls3 = "INSERT INTO [S3] (Student_ID) VALUES('" & MetroLabel3.Text & "')"
            sqls4 = "INSERT INTO [S4] (Student_ID) VALUES('" & MetroLabel3.Text & "')"
            sqls5 = "INSERT INTO [S5] (Student_ID) VALUES('" & MetroLabel3.Text & "')"
            sqls6 = "INSERT INTO [S6] (Student_ID) VALUES('" & MetroLabel3.Text & "')"
            sqls7 = "INSERT INTO [S7] (Student_ID) VALUES('" & MetroLabel3.Text & "')"
            sqls8 = "INSERT INTO [S8] (Student_ID) VALUES('" & MetroLabel3.Text & "')"
            sqly1 = "INSERT INTO [Y1] (Student_ID) VALUES('" & MetroLabel3.Text & "')"
